...
yset5 = 3094:3488
#yset = 1514:2303
#yset <- rbind(yset, yset4)
#yset <- rbind(yset, yset5) # 4-5,1-2
# 1975 = 5*395
for(i in c(2699:3488,1514:2303)){
  for (i in i){
...
firetrain <- Y[c(2699:3488,1514:2303),2] # NOofFire - Y
...
xlisttest[[1]] = rep(1,length(yset3))
xlisttest[[2]] = xtest
