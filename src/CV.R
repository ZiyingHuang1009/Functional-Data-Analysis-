...
Xmatrixtest <- new[-1,] # matrix value - X
firetest <- Y[yset,2] # NOofFire - Y
ytest = log(firetest)
ytest[ytest == "-Inf"]<- 0
...
sum((ytest-ytestfit)^2) # Square Prediction Error
