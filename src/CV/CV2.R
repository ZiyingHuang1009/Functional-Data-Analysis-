...
#yset <- rbind(yset, yset1) # 1,3-5
# 1975 = 5*395
for(i in c(2304:3488,1514:1908)){
  for (i in i){
...
firetrain <- Y[c(2304:3488,1514:1908),2] # NOofFire - Y
...
xlisttest[[1]] = rep(1,length(yset2))
xlisttest[[2]] = xtest
