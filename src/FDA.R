...
# alpha is not equal to the mean of fire
mean(y)
...
betabasis35 = create.fourier.basis(c(0, 52), 35)
...
for (ilam in 1:nlam) {
  ...
  fdParobj = fdPar(betabasis35,int2Lfd(2), lambda)
  betalisti  = betalist1
  betalisti[[2]] = fdPar(betabasis35, int2Lfd(2), lambda)
